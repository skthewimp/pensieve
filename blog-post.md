...
I did some reading on ADHD and "second brain" systems (Tiago Forte's framework and the various Reddit communities around it). The consensus is interesting - the number one reason these systems fail for ADHD people is that they become write-only. Notes go in, nothing useful comes out, you feel guilty about not doing your weekly review, you avoid the system, it dies. Zero-friction capture is necessary but not sufficient. You also need the system to push things back at you.
